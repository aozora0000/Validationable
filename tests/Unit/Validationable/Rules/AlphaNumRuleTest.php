...
class AlphaNumRuleTest extends TestCase
{
    ...
    #[Test]
    public function アルファベット文字列とダッシュ記号の場合はfalseを返す(): void
    {
        // テスト対象のインスタンスを作成
        $instance = new AlphaNumRule();
    ...
    #[Test]
    public function 数字が含まれた文字列の場合はtrueを返す(): void
    {
        // テスト対象のインスタンスを作成
        $instance = new AlphaNumRule();
    ...
    #[Test]
    public function 数値型の場合はtrueを返す(): void
    {
        // テスト対象のインスタンスを作成
        $instance = new AlphaNumRule();
